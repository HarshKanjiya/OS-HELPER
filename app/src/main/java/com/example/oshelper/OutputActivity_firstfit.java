...
public class OutputActivity_firstfit extends AppCompatActivity {
    String[] processStr,blockStr;
    ListView processSize_list,blockSize_list,process_list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_output_firstfit);
...
//      actionbar back button
        ...
        actionbar.setSubtitle("First Fit");
...
//starting python
        ...
        PyObject py = python.getModule("firstfit");
