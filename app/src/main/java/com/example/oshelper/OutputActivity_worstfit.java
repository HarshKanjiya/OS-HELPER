...
public class OutputActivity_worstfit extends AppCompatActivity {
    String[] processStr,blockStr;
    ListView processSize_list,blockSize_list,process_list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_output_worstfit);
...
//      actionbar back button
        ...
        actionbar.setSubtitle("Worst Fit");
...
//starting python
        ...
        PyObject py = python.getModule("worstfit");
