...
public class OutputActivity_priority extends AppCompatActivity {

    ListView process_list,arrivalTime_list,burstTime_list,complitionTime_list,turnaroundTime_list,waitingTime_list,priority_list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_output_priority);
...
//      actionbar back button
        ...
        actionbar.setSubtitle("Priority algorithm");
...
//      receiving data
        ...
        String priority = data_Receive.getString("priority");
...
//algo
        ...
        PyObject fcfs = python.getModule("priority");
        PyObject answer =fcfs.callAttr("main",prno_int,arrivalTime,burstTime,priority);
...
//        process name
        ...
        String[] priority_array = priority.toString().split(",");
...
//        print
        ...
        ArrayAdapter p = new ArrayAdapter(this, android.R.layout.simple_list_item_1,priority_array);
        priority_list.setAdapter(p);
